...
const HeroSection = () => {
  ...
  return (
    <section className="relative bg-gray-900 text-white min-h-screen flex items-center justify-center px-4 sm:px-6 overflow-hidden">
      ...
      >
        ...
        <motion.p 
          ...
          variants={itemVariants}
        >
          I'm <span className="text-blue-400 font-medium">Yogiraj Bhandare</span> - the data world’s very own Sherlock Holmes. I uncover hidden patterns, solve analytical mysteries . When others see rows and columns, I see clues
        </motion.p>
